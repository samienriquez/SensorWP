...
namespace sdkBluetoothA2DWP8CS
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        ObservableCollection<String> codes;  // a local copy of paired device information
        
        public int Valuespersecond{get;set;}
        ...
        private async void ConnectToDevice(PeerInformation peer)
        {
            ...
            try
            {
             ...
             ViewModel objViewModel = new ViewModel();
                ...
                {
                  //  await reader.LoadAsync(1);
                   // System.Console.Write(reader.ReadByte());
                 //  resultado.Text += " "+ reader.ReadByte().ToString();
                    //Debug.WriteLine(""+reader.ReadByte().ToString());
                   char data = Convert.ToChar( reader.ReadByte());
                
                  //  String data = reader.ReadByte().ToString();
                    if (data.Equals(separator))
                    {
                     ...
                     //   Debug.WriteLine("" + code);
                        count = count + 1;
                        //////Grafica
                        objViewModel.Collection.Add(new Model(count,Convert.ToInt16(code)));
                        if (count > 89) {
                            XAxis.MinValue = count - 90;
                            XAxis.MaxValue = count + 15;
                        }
                        ////
                        code = "";
                        if (codes.Count > valuespersecond)
                        {
                            codes.RemoveAt(0);
                        }
                   ...
                   // codesList.ItemsSource = codes;
                    ...
                    ChartContent.DataContext = objViewModel;
                    await reader.LoadAsync(1);
                }
    ...
    public class ViewModel
    {
        ...
        private void GenerateDatas()
        {
            ...
            dt.Start();
            /*    this.Collection.Add(new Model(0, 5));
            this.Collection.Add(new Model(1, 2));
            this.Collection.Add(new Model(2, 10));
        ...
        void dt_Tick(object sender, EventArgs e)
        {
            ...
            int randomNumber = myRandom.Next(500, 1023);
            this.Collection.Add(new Model(count, randomNumber));
            // Do Stuff here.
        }
    }
}
